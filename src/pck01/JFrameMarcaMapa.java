    ...
    private void pegaXY(MouseEvent ponto)
    {
        ...
        if (controle)
        {
            ...
            else
            {
                ...
                //Verifica se existe mais de um vertice cadastrado para mapear as arestas
                if (listVertice.size() > 1)
                {
                    ...
                    else
                    {
                        ...
                        //Verifica o v�rtice mais proximo do click
                        ...
                        for (Vertice v : listVertice) {
                            ...
                            //Verifica se a distancia e a menor que ja foi calculada anteriormente
                        ...
                        //Verifica se o vertice primario ja foi selecionado
                        if (verticePrimario == null)
                        {
                            ...
                            //Deixa o vertice origem com icone de alerta
                            verticePrimario.pontoMapa.setIcon(new ImageIcon(JFrameMapa.class.getResource("/img/alerta.gif")));
                        }
                        else
                        {
                            //Gera a ligacao
                            String custo = JOptionPane.showInputDialog("Aresta de ["+verticePrimario.nome+"] até ["+vertice.nome+"]:");
                            if (!custo.equals(""))
                            {
                                //Deixa o vertice destino com �vone vermelho
                ...
                {
                    JOptionPane.showMessageDialog(this, "Para criar arestas é necessário ao menos um vértice cadastrado.");
                }
            }
        }		
    }
